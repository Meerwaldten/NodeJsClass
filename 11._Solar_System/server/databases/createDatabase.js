...
// Seeding - DML - Tilføjer data til DB'en første gang den startes
...
if(isDeleteMode){
    db.exec(`INSERT INTO people (name, planet_id) VALUES ('Xenius', 3);`);
    db.exec(`INSERT INTO people (name, planet_id) VALUES ('Zando', 3);`);
    db.exec(`INSERT INTO people (name, planet_id) VALUES ('Johannes', 3);`);
}
